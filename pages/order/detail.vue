				...
				uni.showModal({
				    ...
				    success: (resC=>{
						if(resC.confirm){
							...
							let {stateTip, stateTipColor} = this.orderStateExp(state);
							...
							uni.request({
								url: this.$Url + '/clmsj/order/userUpdateOrderStatus', // http://bull.hnw.net/index/bull/client_wash_info
								data: {
									id:item.id,
									state:state
								},
